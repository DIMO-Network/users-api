...
// 2023-02-28 11:45:00.020077 -0500 EST m=+0.047869126
package docs
...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.AlternateAccountsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/user/submit-referral-code": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ReferralCode is the 6-digit, numeric referral code from another user.",
    ...
    "definitions": {
        "controllers.AltAccount": {
            "type": "object",
            "properties": {
                "login": {
                    "description": "Login is the login username for the provider, either an email address\nor an EIP-55-compliant ethereum address.",
                    "type": "string"
                },
                "type": {
                    "description": "Type is the authentication provider, one of \"web3\", \"apple\", \"google\".",
                    "type": "string"
                }
            }
        },
        "controllers.AlternateAccountsResponse": {
            "type": "object",
            "properties": {
                "otherAccounts": {
                    "description": "OtherAccounts is a list of any other accounts that share email or\nethereum address with the provided token.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controllers.AltAccount"
                    }
                }
            }
        },
        ...
        "controllers.UserResponse": {
            ...
            "properties": {
                ...
                "referralCode": {
                    "description": "ReferralCode is the user's referral code to be given to others. It is a 6 digit numeric code,\nonly present if the account has a confirmed Ethereum address.",
                    "type": "string",
                    "example": "883163"
                },
                "web3": {
