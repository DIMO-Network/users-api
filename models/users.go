...
var (
	userAllColumns            = []string{"id", "email_address", "email_confirmed", "email_confirmation_sent_at", "email_confirmation_key", "created_at", "country_code", "ethereum_address", "agreed_tos_at", "auth_provider_id", "ethereum_challenge", "ethereum_challenge_sent", "ethereum_confirmed", "in_app_wallet"}
	userColumnsWithoutDefault = []string{"id", "email_confirmed", "created_at", "auth_provider_id", "ethereum_confirmed"}
	userColumnsWithDefault    = []string{"email_address", "email_confirmation_sent_at", "email_confirmation_key", "country_code", "ethereum_address", "agreed_tos_at", "ethereum_challenge", "ethereum_challenge_sent", "in_app_wallet"}
